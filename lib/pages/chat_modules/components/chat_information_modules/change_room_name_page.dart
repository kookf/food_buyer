...
class ChangeRoomNamePage extends StatefulWidget {
  ...
  const ChangeRoomNamePage({Key? key, required this.roomKey,
...
class _ChangeRoomNamePageState extends State<ChangeRoomNamePage> {
  ...
  requestDataWithChangeRoomName() async {
    ...
    var json =
        await DioManager().kkRequest(Address.chatChangeName, params: params);
    if (json['code'] == 200) {
  ...
  void initState() {
    ...
    super.initState();
    editingController.text = widget.roomName;
  }
