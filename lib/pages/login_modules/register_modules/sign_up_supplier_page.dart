...
class _SignUpSupplierPageState extends State<SignUpSupplierPage> {
  ...
  requestDataWithCreateSupplier()async{
    ...
    var json = await DioManager().kkRequest(Address.userCreateSupplier,
        bodyParams: params);
    if(json['code'] == 200){
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          hintText: 'Type in your user name(display in chatroom)',
                 ...
                 userNameController.text.isEmpty?
                  ...
                  Container(
                    ...
                    child: const TextField(
                      ...
                      decoration: InputDecoration(
                          hintText: 'Type in your business registration number name',
                          border: InputBorder.none),
                    ),
                  ),
              ...
              child: Center(
                child: MaterialButton(
                  onPressed: () {
                    ...
                    if(userNameController.text.isEmpty||companyNameController.text.isEmpty
